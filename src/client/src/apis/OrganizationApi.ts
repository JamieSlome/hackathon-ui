...
import type { Organization } from "../models/index";
import { OrganizationFromJSON, OrganizationToJSON } from "../models/index";
...
export interface OrganizationApiInterface {
   ...
   */
  findOrganizationRaw(
    requestParameters: FindOrganizationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Organization>>;
...
export class OrganizationApi
  ...
  implements OrganizationApiInterface
{
  /**
   * Create an organization.
   * Create an organization.
  ...
  async createOrganizationRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "organization",
        "Required parameter requestParameters.organization was null or undefined when calling createOrganization."
      );
    }
  ...
  async findOrganizationRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling findOrganization."
      );
    }
  ...
  async findOrganization(
    ...
    const response = await this.findOrganizationRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
