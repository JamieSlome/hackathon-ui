...
export interface ActivityApiInterface {
   ...
   */
  findActivityRaw(
    requestParameters: FindActivityRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Activity>>;
   ...
   * @param {number} [beneficiaryId] Beneficiary identifier
   * @param {number} [needId] Need identifier
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof ActivityApiInterface
   */
...
export class ActivityApi
  ...
  implements ActivityApiInterface
{
  /**
   * Create an activity.
   * Create an activity.
  ...
  async createActivityRaw(
    ...
    if (
      requestParameters.activityCreationRequest === null ||
      requestParameters.activityCreationRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "activityCreationRequest",
        "Required parameter requestParameters.activityCreationRequest was null or undefined when calling createActivity."
      );
    }
    ...
    const response = await this.request(
      {
        ...
        body: ActivityCreationRequestToJSON(
          requestParameters.activityCreationRequest
        ),
      },
      initOverrides
    );
  ...
  async findActivityRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling findActivity."
      );
    }
  ...
  async findActivity(
    ...
    const response = await this.findActivityRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
